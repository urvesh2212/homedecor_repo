                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.product-categories.update", [$productCategory->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('category_code') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="category_code" id="category_code" value="{{ old('category_code', $productCategory->category_code) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('category_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="category_name" id="category_name" value="{{ old('category_name', $productCategory->category_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('category_status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="category_status" id="category_status" required>
                                ...
                                @foreach(App\Models\ProductCategory::CATEGORY_STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('category_status', $productCategory->category_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
