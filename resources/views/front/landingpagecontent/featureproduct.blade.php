            ...
            <div class="col-lg-12">
                ...
                <div class="single-row-slider-wrapper">
                    ...
                    {"breakpoint":479, "settings": {"slidesToShow": 1, "arrows": false} }
                        ...
                        @foreach($featuredproduct as $id => $data)
                        ...
                        <div class="col">
                            ...
                            <div class="single-grid-product">
                                <div class="single-grid-product__image">
                                    ...
                                    <a href="{{route('singleproductroute',['productid' => $data->featured_product->id,'productname' => str_replace(' ','-',$data->featured_product->product_name)])}}">
                                        <img src="{{$data->featured_product->getFirstMediaUrl('product_img','preview')}}" class="img-fluid" alt="" loading="lazy">
                                    </a>
                                </div>
                                <div class="single-grid-product__content">
                                    <div class="single-grid-product__category-rating">
                                        <span class="category"><a href="shop-left-sidebar.html">{{$data->featured_product->product_name}}</a></span>
                                    </div>
