@extends('front.root')
  @section('content')
    <div class="breadcrumb-content">
        <h2 class="breadcrumb-content__title">About Us</h2>
                          ...
                          <div class="row row-10">
                              ...
                              <div class="col-md-4">
                                  <div class="single-banner">
                                      <a href="#"><img src="assets/img/banners/banner7.jpg" class="img-fluid" alt="Banner"></a>
                                  </div>
                              </div>
                              <div class="col-md-4 col-12">
                                  <div class="single-banner">
                                      <a href="#"><img src="assets/img/banners/banner8.jpg" class="img-fluid" alt="Banner"></a>
                                  </div>
                              </div>
                              <div class="col-md-4 col-12">
                                  <div class="single-banner">
                                      <a href="#"><img src="assets/img/banners/banner9.jpg" class="img-fluid" alt="Banner"></a>
                                  </div>
